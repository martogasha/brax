                ...
                <div class="col-lg-4 col-md-5">
                    <div class="widgets_container contact_us">
                        ...
                        <div class="footer_contact">
                            <ul>
                                <li><i class="zmdi zmdi-home"></i><span>Addresss:</span> Sigona</li>
                                <li><i class="zmdi zmdi-phone-setting"></i><span>Phone:</span><a href="tel:(+1) 866-540-3229">0754238704</a> </li>
                                <li><i class="zmdi zmdi-email"></i><span>Email:</span>  braxlanshop.com</li>
                            </ul>
                        </div>
...
<!-- Mirrored from demo.hasthemes.com/pallas-preview/pallas/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Mar 2020 11:12:47 GMT -->
</html>
