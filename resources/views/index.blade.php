                ...
                <div class="slider_area slider_two owl-carousel">
                    <div class="single_slider d-flex align-items-center" data-bgimg="assets/img/slider/slider3.jpg">
                        <div class="slider_content slider_content_two content_position_center">
                            <h1> Denim Jackets </h1>
                            <span>High-Quality <br> Jackets </span>
                            <h2><span>Ksh</span> 500</h2>
                    ...
                    <div class="single_slider d-flex align-items-center" data-bgimg="assets/img/slider/slider4.jpg">
                        <div class="slider_content slider_content_two content_position_left">
                            <h1>Denim Jackets </h1>
                            <span>High-Quality <br> Jackets </span>
                            <h2><span>form</span> Ksh:500  <span>00</span></h2>
                            <a href="{{url('category')}}">shop now</a>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach($fronts as $front)
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a href="{{url('productDetails',$front->id)}}"><img src="{{asset('uploads/employee/'. $front->image)}}" alt=""></a>
                                ...
                                <div class="product_content">
                                    <div class="product_name">
                                        <h3><a href="{{url('productDetails',$front->id)}}">{{$front->desc}}</a></h3>
                                    </div>
                                    ...
                                    <div class="action_links">
                                        <ul>
                                            <form action="{{url('addCart')}}" method="post" id="indexForm">
                                                @csrf
                                                <li class="wishlist"><a href="" title="Add to Wishlist"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                                                <input type="hidden" name="picId" value="{{$front->id}}">
                                                <li class="add_to_cart"><a href="javascript:document.getElementById('indexForm').submit();" title="add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i> add to cart</a></li>
